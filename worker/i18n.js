...
const DICT = {
  ru: {
    ...
    s_schedule: "Расписание", s_remind: "Напоминание", s_lang: "Язык",
    s_remind_off: "выключено", s_remind_at: n => `за ${n} мин до пары`,
  ...
  en: {
    ...
    s_schedule: "Timetable", s_remind: "Reminder", s_lang: "Language",
    s_remind_off: "off", s_remind_at: n => `${n} min before class`,
